...
using NexusHR.Application.Validators;
using NexusHR.Api.JsonConverters;
...
app.UseMiddleware<NexusHR.Api.Middleware.GlobalExceptionMiddleware>();

// Añadir CorrelationId a todos los logs de cada petición (debe ir antes del request logging)
app.UseMiddleware<NexusHR.Api.Middleware.CorrelationIdMiddleware>();
...
if (app.Environment.IsDevelopment())
{
    using (var scope = app.Services.CreateScope())
    {
        ...
        await NexusHR.Infrastructure.Data.SeedData
